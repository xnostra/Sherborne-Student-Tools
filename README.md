...
- **License**: the current Microsoft 365 A5 for Students entitlement (`M365EDU_A5_STUUSEBNFT`, Student Use Benefit) is recommended automatically when it has spare seats; press Enter to use it or choose any other available SKU. The available-seat calculation matches the Microsoft 365 admin centre, including seats in the subscription warning/grace period. If the student A5 entitlement is full, the script warns you but keeps the other available license choices.
