...
- **License**: the current Microsoft 365 A5 for Students entitlement (`M365EDU_A5_STUUSEBNFT`, Student Use Benefit) is recommended automatically when it has spare seats; press Enter to use it or choose another available SKU. If the student A5 entitlement exists but is full, the script stops and tells you to free or buy seats rather than creating unlicensed students.
